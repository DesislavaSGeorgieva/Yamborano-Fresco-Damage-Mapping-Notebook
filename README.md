...
Source photographic material used in the analysis

📂 outputs/

Selected visual and quantitative outputs

📓 Recovering_the_Unrecoverable_Yamborano_Fresco_Damage_Mapping_Notebook.ipynb

Complete computational research notebook

📦 requirements.txt

Python dependencies required by the notebook
...
Citation metadata for the research software
